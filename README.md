...
Used memory may be different from other such monitors due to used RAM being calculated with formula
MemTotal - MemAvailable(memory available without swapping) leading to more usage shown.
